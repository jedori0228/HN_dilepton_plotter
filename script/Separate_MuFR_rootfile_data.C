void Separate_MuFR_rootfile_data(TString inputdir, TString outdir, int ForWhichTrigger){
  ...
  TFile *file_all_DoubleMuon = new TFile(filepath+"FRCalculator_Mu_dxysig_DILEP_data_DoubleMuon_cat_"+catversion+".root");
  TFile *file_all_SingleMuon = new TFile(filepath+"FRCalculator_Mu_dxysig_DILEP_data_SingleMuon_cat_"+catversion+".root");
...
*/
  ...
  if(ForWhichTrigger==0){
    HLTsToUse = {"HLT_Mu3_PFJet40_v", "HLT_Mu8_TrkIsoVVL_v", "HLT_Mu17_TrkIsoVVL_v"};
    WhichData = {"DoubleMuon", "DoubleMuon", "DoubleMuon"};
    HLTsNotUse = {"HLT_Mu8_v", "HLT_Mu17_v", "HLT_IsoMu24_v", "HLT_Mu20_v"};
  }
  //==== For IsoMu24
  ...
  TString filename = "FRCalculator_Mu_dxysig_DILEP_data_DoubleMuon_cat_"+catversion+".root";
