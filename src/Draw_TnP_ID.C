...
void Draw_TnP_ID(int period){
  ...
  TString CutsOnDen_front = "pair_probeMultiplicity_bin0";
  ...
  vector<TString> fitftns = {
    "vpvPlusExpo",  "vpvPlusExpo2",  "vpvPlusExpo3",  "vpvPlusExpo4",  "vpvPlusExpo5",  "vpvPlusExpo6",  "vpvPlusExpoMin70",  "vpvPlusCMS",  "vpvPlusCMSloweff",  "vpvPlusCMSloweff2",  "vpvPlusCMS2",  "vpvPlusCMSbeta0p2",  "vpvPlusCMS3",  "cpvPlusCMS",  "cpvPlusCMS2",  "cpvPlusCMS3",  "cpvPlusCMS4",  "cpvPlusCMS5",  "cpvPlusCMS7",  "cpvPlusCMS8",  "cpvPlusCMSbeta0p2",  "cpvPlusExpo",  "cpvPlusExpo3",  "cpvPlusQuad",  "cpvPlusQuad2",  "cpvPlusCubic",  "cpvPlusQuart",  "cpvPlusQuart2",  "cpvPlusQuart3",  "vpvPlusQuad",  "vpvPlusQuad2",  "vpvPlusCubic",  "vpvPlusCubic2",  "vpvPlusCubic3",  "vpvPlusQuart",  "vpvPlusQuart2",  "vpvPlusQuart3",  
  };
  ...
  for(unsigned int it_syst=0; it_syst<systs.size(); it_syst++){
    ...
    TString plotpath = base_plotpath+syst+"/";
		...
		//==== make SF root file
		TString CutsOnDen2 = "pair_probeMultiplicity_bin0_&_tag_combRelIsoPF04dBeta_bin0_&_tag_pt_bin0";

		TCanvas *c_IDEff_Data = (TCanvas*)file_ID_Data->Get(dirname+"fit_eff_plots/abseta_pt_PLOT_"+CutsOnDen2);
		TCanvas *c_IDEff_MC = (TCanvas*)file_ID_MC->Get(dirname+"fit_eff_plots/abseta_pt_PLOT_"+CutsOnDen2);

		TH2F *hist_IDEff_Data = (TH2F*)c_IDEff_Data->GetPrimitive("abseta_pt_PLOT_"+CutsOnDen2)->Clone();
		TH2F *hist_IDEff_MC = (TH2F*)c_IDEff_MC->GetPrimitive("abseta_pt_PLOT_"+CutsOnDen2)->Clone();
