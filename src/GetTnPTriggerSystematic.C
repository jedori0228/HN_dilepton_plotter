...
void GetTnPTriggerSystematic(){
  ...
  vector< vector<TString> > vsysts  = { {"Central"}, {"NMassBins30", "NMassBins50"}, {"MassRange_60_130", "MassRange_70_120"}, {"SignalShapeSingleV"}, {"TagPt20IsoInf", "TagPt30Iso0p08"}, {"ProbeMult99"} };
