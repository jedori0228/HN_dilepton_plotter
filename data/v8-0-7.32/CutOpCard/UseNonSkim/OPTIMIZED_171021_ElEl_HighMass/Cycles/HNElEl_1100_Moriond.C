...
void HNElEl_1100_Moriond(){

  bool DoDebug = false;

  TString CutOpCardDir = "UseNonSkim/OPTIMIZED_171021_ElEl_HighMass";
  ...
  for(unsigned int i=0; i<systs.size(); i++){
    ...
    if(i==0){
      ...
      //signal_calculated_syst = (8.56*0.01)*y_signal_central;
