...
CutCardDirName = "UseNonSkim/OPTIMIZED_171021_MuMu_LowMass_Bin2"
...
void {4}(){{
  ...
  for(unsigned int i=0; i<systs.size(); i++){{
    ...
    if(i==0){{
      ...
      signal_calculated_syst = (7.15*0.01)*y_signal_central;
