...
for ch in channels:
  ...
  for Bin in Bins:
    ...
    CutCardDirName = "CyclesForOptimization_"+ch+"_"+Bin+"/Cards/"
    os.system('mkdir -p '+CutCardDirName)
    ...
    for mass in masses:
      ...
      os.system('cp '+CutCardDirName_Opt+'/HN'+ch+'_'+str(mass)+'.txt '+CutCardDirName)
