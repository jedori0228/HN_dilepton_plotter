...
os.system("mkdir -p CyclesForInclusiveSR")
...
for ch in channels:
  ...
  for Bin in Bins:
    ...
    for mass in masses:
      ...
      filename = ch+"_"+Bin+"_"+filename

      out = open("CyclesForInclusiveSR/"+filename+".C","w")
...
}}'''.format(TreeSkim, SkimmedTreeDir, str(mass), CutCardDirName, filename, ch, PDName, Lepch, AddCF)
##              0            1             2            3            4       5  6      7     8

      os.system('mkdir -p Outputs_InclusiveSR')
      cmd = "root -l -b -q CyclesForInclusiveSR/"+filename+".C &> Outputs_InclusiveSR/CyclesForInclusiveSR_"+filename+".txt &"
      print cmd
