...
for mass in masses:
  ...
  logfilename = 'log_HN'+channel+'_'+str(mass)+'_VBF.log'
  if not DoBin1:
    logfilename = 'log_Bin2_HN'+channel+'_'+str(mass)+'_VBF.log'
  ...
  outname = 'Datacards/HN'+channel+"_"+str(mass)+'_VBF.txt'
  if not DoBin1:
    outname = 'Datacards/Bin2_HN'+channel+"_"+str(mass)+'_VBF.txt'
  out = open(outname,'w')
